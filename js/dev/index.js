  ...
  if (document.querySelector(".work__slider")) {
    new Swiper(".work__slider", {
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".controls-work-slider__prev",
        nextEl: ".controls-work-slider__next"
      },
      /*
      // Брейкпоінти
      breakpoints: {
...
function menuInit() {
  document.addEventListener("click", function(e) {
    ...
    if (document.documentElement.hasAttribute("data-fls-menu-open")) {
      document.querySelector(".page").classList.add("get-opacity");
    } else {
      document.querySelector(".page").classList.remove("get-opacity");
    }
    if (bodyLockStatus && e.target.closest(".menu__item") && document.documentElement.hasAttribute("data-fls-menu-open")) {
      document.querySelector(".page").classList.remove("get-opacity");
...
var _gsap = {
  ...
  registerEffect: function registerEffect(_ref3) {
    ...
    _effects[name] = function(targets, vars, tl) {
      return effect(toArray(targets), _setDefaults(vars || {}, defaults22), tl);
    };
    if (extendTimeline) {
...
videoBlocks.forEach((block) => {
  block.addEventListener("click", (e) => {
    const video = e.target.firstElementChild;
    video.classList.add("video-event");
    const videoInfo = e.target.nextElementSibling;
    videoInfo.addEventListener("click", (e2) => {
      video.classList.remove("video-event");
    });
  });
});
const grid = document.querySelector(".work__items");
const items = document.querySelectorAll(".item-work");
items.forEach((item) => {
  if (isMobile && window.innerWidth > 991.98) {
    item.addEventListener("click", (e) => {
      console.log(item.getAttribute("id"));
      items.forEach((el) => {
        el.classList.remove("active-item--touch");
      });
      item.classList.add("active-item--touch");
    });
  }
  if (isMobile && window.innerWidth <= 991.98 && window.innerWidth >= 767.98) {
    item.addEventListener("click", (e) => {
      console.log(e.target);
      if (item.classList.contains("active-item--992")) {
        item.classList.remove("active-item--992");
        gsapWithCSS.to(item, {
          "--innerTrack": "0fr",
          duration: 0.3
        });
      } else {
        item.classList.add("active-item--992");
        gsapWithCSS.to(item, {
          "--innerTrack": "1fr",
          duration: 0.3
        });
  ...
  if (isMobile && window.innerWidth < 767.98) {
    const info = item.querySelector(".item-work__info");
    const itemInfoWidth = item.querySelector(".item-work__image").clientWidth;
    item.querySelector(".item-work__info").style.width = itemInfoWidth + "px";
    item.addEventListener("click", () => {
      if (item.classList.contains("active-item--768")) {
        item.classList.remove("active-item--768");
        gsapWithCSS.to(item, {
          "--innerTrack": "0fr",
          duration: 0.3
        });
        ...
        item.classList.add("active-item--768");
        gsapWithCSS.to(item, {
          "--innerTrack": "0fr",
          duration: 0.3
        });
...
const langArr = {
  ...
  workText: {
    ru: "Здесь представлены мои проекты в web-разработке. Я стремился реализовать проекты, которые не только соответствуют техническим требованиям, но и обеспечивают удобный пользовательский интерфейс. Мои основные скилы это JavaScript, React, Minista, SCSS, Tilwind CSS, CMS Tilda и WordPress.",
    en: "Here are my projects in web development. I have been striving to implement projects that not only meet the technical requirements but also provide a user-friendly interface. My main skills are JavaScript, React, Minista, SCSS, Tilwind CSS, CMS Tilda, and WordPress."
  },
  contactsTitle: {
    ru: "Контакты",
    en: "Contacts"
  ...
  contactsText: {
    ru: "Я всегда открыт для интересных предложений и сотрудничества!",
    en: "I am always open to interesting offers and collaborations!"
  },
  workDescr1P1: {
    ru: "Сайт предлагает услуги по реставрации антикварной мебели, производству авторской мебели на заказ и продает мастер-классы. Сверстан на платформе Tilda с использованием стороннего кода. Комбинируются стандартные и Z-блоки.",
    en: "The site offers services for the restoration of antique furniture and the production of custom furniture. Sale of master classes. The site is set up on the Tilda platform using third-party code. Standard and Z-blocks are combined."
  },
  workDescr1P2: {
    ru: "Технологии: Figma, Tilda, JS, CSS",
    en: "Skills: Figma, Tilda, JS, CSS"
  },
  workDescr2P1: {
    ru: "Сайт представляет собой онлайн-платформу, предназначенную для продажи мастер-классов по йоге. Сверстан на платформе Tilda с использованием стороннего кода. Комбинируются стандартные и Z-блоки.",
    en: "The website is an online platform designed for selling yoga master classes. It is built on the Tilda platform using third-party code. Standard and Z-blocks are combined."
  },
  workDescr2P2: {
    ru: "Технологии: Figma, Tilda, JS, CSS",
    en: "Skills: Figma, Tilda, JS, CSS"
  ...
  workDescr3P1: {
    ru: "Интернет-магазин комнатных растений предлагает разнообразные цветы в горшках для украшения интерьера дома или офиса. Оформление заказа простое и быстрое, предусмотрена  доставка по указанному адресу. Сайт разработан на JS, фреймворках React и Tailwind CSS.",
    en: "The online store of indoor plants offers a variety of potted flowers to decorate the interior of your home or office. The ordering process is simple and quick, and delivery is available to the specified address. The website is developed using JS, React frameworks, and Tailwind CSS."
  },
  workDescr3P2: {
    ru: "Технологии: Figma, React, Tailwind CSS, JS, Vite",
    en: "Skills: Figma, React, Tailwind CSS, JS, Vite"
  },
  workDescr4P1: {
    ru: "Интернет-магазин косметики — удобная платформа для покупки качественной декоративной и уходовой продукции известных брендов. Заказ оформляется просто, доступен выбор способа доставки и оплаты. Сайт разработан на JS, SCSS, GULP.",
    en: "The online cosmetics store is a convenient platform for purchasing high-quality decorative and care products from well-known brands. The order is placed in a simple way, and the delivery and payment methods are available. The website is developed in JS, SCSS, and GULP."
  },
  workDescr4P2: {
    ru: "Технологии: Figma, SCSS, JS, GULP",
    en: "Skills: Figma, SCSS, JS, GULP"
  },
  itemWorkDescr1P1: {
    ru: "Сайт сверстан на платформе Tilda с использованием стороннего кода. Комбинируются стандартные и Z-блоки.",
    en: "The website is built on the Tilda platform using third-party code. Standard and Z-blocks are combined."
  },
  itemWorkDescr1P2: {
    ru: "Технологии: Figma, Tilda, JS, CSS",
    en: "Skills: Figma, Tilda, JS, CSS"
  ...
  itemWorkDescr3P1: {
    ru: "Интернет-магазин комнатных растений предлагает разнообразные цветы в горшках для украшения интерьера дома или офиса.",
    en: "The online store of indoor plants offers a variety of potted flowers to decorate the interior of your home or office."
  },
  itemWorkDescr3P2: {
    ru: "Технологии: Figma, React, Tailwind CSS, JS, Vite",
    en: "Skills: Figma, React, Tailwind CSS, JS, Vite"
  ...
  itemWorkDescr4P1: {
    ru: "Интернет-магазин косметики — удобная платформа для покупки качественной декоративной и уходовой продукции известных брендов.",
    en: "The online cosmetics store is a convenient platform for purchasing high-quality decorative and care products from well-known brands."
  },
  itemWorkDescr4P2: {
    ru: "Технологии: Figma, SCSS, JS, GULP",
    en: "Skills: Figma, SCSS, JS, GULP"
...
window.addEventListener("DOMContentLoaded", () => {
  const langSelects = document.querySelectorAll("[data-select-lang]");
  const allLang = ["en", "ru"];
